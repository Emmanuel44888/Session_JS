function mafonction() {
    //Bonx de confirmation
    //var bin = confirm("press a button!");

    //box d'afficharge avec une zone de saisie
    ...
    // Types de variables selon la valeur affectée
    ...
    //Affiche undefined
    // le mot clé var a une visibilité, portee (scope) globale
    var x;
    ...
    // Utiliser eval() pour evaluer une expressions
    // arithmetique sous forme de chaines de caracteres
    // (string)
    var str = "2 + 3 * 5";
    console.log(eval(str)); // Affiche 17

    // Méthodes utiles pour les chaines de caracteres (string)

    //lenght : la longueur de la chaine
    // toUppercase() : pour convertir une chaine de caracteres en majuscule
    // toLowerCase() : pour convertir une chaine de carcateres en minuscule
    // trim() : Supprime les espaces au debut et a la fin
    //substr() : extrait une sous chaine de caracteres en minuscule
    // indexOf() : retourne la position d'une sous-chaines dans une chaine, -1 sinon
    ...
    // Pour extraire, les 3 derniers caracteres on utilise une valeur negative.
    console.log(str2.substr(-3)); // Affiche ou
    // substring() => prend comme parametre l'indice de debut et l'indice de fin (non-inclus)
    console.log(str2.substring(1, 3)); // Affiche on
    // Determine l'indice de la sous chaine "jour" dans "bonjour"
 ...
 // Exercice 1 :
    ...
    console.log("Aujourd'hui, nous sommes " + daylist[day] + ", et il est " + hour + "h" + minute
        ...
        if(x > 0){
            ...
            // Utiliser else if pour spécifier une nouvelle condition; si la première est fausse
        } else if(x < 0){
            console.log(x + " est strictement négatif");
            // Specifie un bloc de code est executer, si la meme condition est fausse
        } else {
...
// Ecrire un code JS qui demande deux entiers a un utilisateur et affiche le plus grand.


// Ecrire un code JS qui permet d' afficher les nombres pairs compris entre 0 et 10.

// Ecrivez un programme JavaScript qui itère les entiers de 1 à 100 :
...
// Ecrivez un programme JS pour calculer la somme et le produit d'un tableau d'entiers.
...
// // Demande à l'utilisateur de rentrer un mombre et teste sa parité
// var nbr = prompt('Saisir un nombre');
// if (nbr % 2 == 0) {
//     alert("pair");
...
// Ecrire un code JS qui demande deux entiers a un utilisateur et affiche le plus grand.
    ...
    // alert(nbr1);
    // var nbr2 = prompt ('saisir un nombre');
    // alert(nbr2);

    // if(nbr1 < nbr2) {
    // alert("nbr1 est plus petit que nbr2");
    // }
    // else {
